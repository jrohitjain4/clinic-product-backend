...
const sendStaffWelcomeEmail = async (to, staffName, staffCode, roleName, credentials) => {
    try {
        const frontendLink = process.env.FRONTEND_URL?.split(",")[0] || "https://docyori.com";
        const loginUrl = `${frontendLink}/login`;
        // Fetch support contacts from settings
        ...
        `;
        return await (0, exports.sendEmail)(to.toLowerCase(), "Welcome to DocYori! Your Staff Account Details", emailBody);
    }
    catch (error) {
