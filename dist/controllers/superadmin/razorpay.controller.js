...
exports.activateRazorpayConfig = exports.deleteRazorpayConfig = exports.upsertRazorpayConfig = exports.getRazorpayConfig = void 0;
...
const saveCredentialsList = async (list) => {
...
const upsertRazorpayConfig = async (req, res) => {
    try {
        if (req.user?.role !== "SUPER_ADMIN") {
            return res.status(403).json({ message: "Forbidden" });
        }
        ...
        if (id) {
            ...
            const encryptedSecret = keySecret === "********" ? existing.keySecret : (0, encryption_1.encrypt)(keySecret);
            ...
            const newCred = {
                ...
                label,
                keyId,
                keySecret: (0, encryption_1.encrypt)(keySecret),
                isActive,
            };
...
exports.upsertRazorpayConfig = upsertRazorpayConfig;
// DELETE /api/superadmin/razorpay-config/:id
const deleteRazorpayConfig = async (req, res) => {
    try {
        if (req.user?.role !== "SUPER_ADMIN") {
            return res.status(403).json({ message: "Forbidden" });
        }
...
exports.deleteRazorpayConfig = deleteRazorpayConfig;
// PUT /api/superadmin/razorpay-config/:id/activate
const activateRazorpayConfig = async (req, res) => {
    try {
        if (req.user?.role !== "SUPER_ADMIN") {
            return res.status(403).json({ message: "Forbidden" });
        }
...
exports.activateRazorpayConfig = activateRazorpayConfig;
