...
export const sendPatientRegistrationEmail = async (
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "Patient Registration Successfully", emailBody);
    } catch (error) {
...
export const sendPatientAppointmentEmail = async (
    to: string,
    patientName: string,
    doctorName: string,
    date: string,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "Your Appointment Confirmation", emailBody);
    } catch (error) {
...
export const sendDoctorRegistrationEmail = async (
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "Doctors registration Successfully", emailBody);
    } catch (error) {
...
export const sendDoctorAppointmentEmail = async (
    to: string,
    doctorName: string,
    patientName: string,
    date: string,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "New Appointment Assigned", emailBody);
    } catch (error) {
...
export const sendClinicWelcomeTrialEmail = async (
    to: string,
    ownerName: string,
    username: string,
    password?: string,
    planName: string = "Enterprise",
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "Welcome to DocYori! Free Trial Started", emailBody);
    } catch (error) {
...
export const sendClinicSubscriptionActivatedEmail = async (
    to: string,
    ownerName: string,
    planName: string,
    amount: number,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), isRenewal ? "Your Subscription Has Been Renewed" : "Subscription Activated Successfully", emailBody);
    } catch (error) {
...
export const sendClinicSubscriptionExpiredEmail = async (
    to: string,
    ownerName: string,
    planName: string,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), titleText, emailBody);
    } catch (error) {
...
export const sendClinicSubscriptionExpiringSoonEmail = async (
    to: string,
    ownerName: string,
    planName: string,
    expiresAt: Date,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "Subscription Expiring Soon!", emailBody);
    } catch (error) {
...
export const sendClinicAppointmentNotificationEmail = async (
    to: string,
    ownerName: string,
    patientName: string,
    doctorName: string,
    ...
    try {
        ...
        return await sendEmail(to.toLowerCase(), "New Appointment Booked", emailBody);
    } catch (error) {
